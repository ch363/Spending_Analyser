...
from .categorize import merchant_display_name, merchant_group
...
def detect_recurring_transactions(
	...
	The detector looks for transactions that repeat on a regular cadence with
	consistent amounts. Supported cadences are weekly, bi-weekly, and monthly.
	"""
	...
	for group_key, group_df in spend.groupby("group_key"):
		...
		if confidence < 0.6:  # require at least 60% of charges to align in price
			continue
